...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    THSegmentedPager *page = (THSegmentedPager *) self.window.rootViewController;
    NSMutableArray *pages = [NSMutableArray new];
    for (int i = 0; i < 4; i++) {
        UIViewController *pagedViewController = [page.storyboard instantiateViewControllerWithIdentifier:@"THSegmentedPager"];
