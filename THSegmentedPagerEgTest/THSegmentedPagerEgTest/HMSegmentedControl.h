 ...
 */
@property (nonatomic, strong) IBInspectable UIColor *selectionIndicatorColor UI_APPEARANCE_SELECTOR;
...
/**
 ...
 Default is `0.2f`
 */
@property (nonatomic) IBInspectable CGFloat selectionIndicatorBoxOpacity;
 ...
 */
@property (nonatomic, assign) IBInspectable HMSegmentedControlType type;
 ...
 */
@property (nonatomic, assign) IBInspectable HMSegmentedControlSelectionStyle selectionStyle;
 ...
 */
@property (nonatomic, assign) IBInspectable HMSegmentedControlSegmentWidthStyle segmentWidthStyle;
 ...
 */
@property (nonatomic, assign) IBInspectable HMSegmentedControlSelectionIndicatorLocation selectionIndicatorLocation;
 ...
 */
@property (nonatomic, assign) IBInspectable HMSegmentedControlBorderType borderType;
 ...
 */
@property (nonatomic, assign)IBInspectable NSInteger selectedSegmentIndex;
...
/**
 ...
 Default is 5.0
 */
@property (nonatomic, readwrite)IBInspectable CGFloat selectionIndicatorHeight;
...
/**
 ...
 Defaults are top: 0.0f
           ...
           bottom: 0.0f
            right: 0.0f
 */
@property (nonatomic, readwrite) IBInspectable UIEdgeInsets selectionIndicatorEdgeInsets;
